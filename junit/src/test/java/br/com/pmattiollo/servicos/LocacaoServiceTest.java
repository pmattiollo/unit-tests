...
public class LocacaoServiceTest {
	...
	public void deveAlugarFilme() throws Exception {
		...
		List<Filme> filmes = Stream.of(new Filme("Filme 1", 2, 5.0)).collect(Collectors.toList());
		...
		errorCollector.checkThat(locacao.getDataRetorno(), ehHojeComDiferencaDeDias(2));
	}
	...
	public void naoDeveAlugarFilmeSemEstoque() throws Exception {
		...
		List<Filme> filmes = Stream.of(new Filme("Filme 2", 0, 5.0)).collect(Collectors.toList());
	...
	public void naoDeveAlugarFilmeSemUsuario() throws FilmeSemEstoqueException {
		// Cenário
		List<Filme> filmes = Stream.of(new Filme("Filme 3", 1, 4.0)).collect(Collectors.toList());
	...
	public void deveDevolverNaSegundaAoAlugarNoSabado() throws FilmeSemEstoqueException, LocadoraException {
		...
		// Cenário
		Usuario usuario = new Usuario("Usuario 1");
		List<Filme> filmes = Stream.of(new Filme("Filme 1", 1, 5.0)).collect(Collectors.toList());
